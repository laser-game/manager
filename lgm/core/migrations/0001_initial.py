# Generated by Django 2.0.2 on 2018-02-14 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('x_modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('time_on', models.DateTimeField(verbose_name='Time of switch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('switch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='type_game_switch', to='core.Switch')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='event',
            name='player1',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='event_type_player1', to='core.Player'),
        ),
        migrations.AddField(
            model_name='event',
            name='player2',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='event_type_player2', to='core.Player'),
        ),
        migrations.AddField(
            model_name='event',
            name='type_event',

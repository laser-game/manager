# Generated by Django 2.0.6 on 2018-06-23 19:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sound_set_type', models.CharField(choices=[('CZ', 'czech'), ('EN', 'english')], max_length=1, verbose_name='Set of sounds')),
        ...
        migrations.CreateModel(
            name='Game',
            fields=[
                ('typegame_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='core.TypeGame')),
        ...
        migrations.AddField(
            model_name='typegameswitch',
            name='type_game',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='type_game_switch_type_game', to='core.TypeGame'),
        ),
        migrations.AddField(
            model_name='team',
            name='type_color',
        ...
        migrations.AddField(
            model_name='gameplayer',
            name='game',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='game_player_game', to='core.Game'),
        ),
        migrations.AddField(
            model_name='event',
            name='game',
